...
const cycleTotal = computed(() => {
  cycle01.value = check(cycle01.value, 0, 22)
  cycle02.value = check(cycle02.value, cycle01.value + 1, 23)
  return cycle01.value + '-' + cycle02.value
})
const averageTotal = computed(() => {
  average01.value = check(average01.value, 0, 22)
  average02.value = check(average02.value, 1, 23 - average01.value)
